          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text18">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text17 thq-body-small">
                                  Explore our chatbot development and social
                        ...
                        <div className="navbar8-content4">
                          ...
                          <span>
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text27 thq-body-small">
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span>
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text17 thq-body-small">
                            Explore our chatbot development and social media
...
Navbar8.defaultProps = {
  ...
  action2: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1561623211-a35ce8d8dd7b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODA1MzA3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  page2: undefined,
  logoSrc:
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1643473232037-08736b56178d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODA1MzA3Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page1ImageAlt: 'Home Image',
  link1: undefined,
  page1: undefined,
  linkUrlPage1: 'https://www.teleporthq.io',
  logoAlt: 'AI Automation Agency Logo',
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1485811055483-1c09e64d4576?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODA1MzA3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  page1Description: undefined,
  link2: undefined,
  page3ImageAlt: 'About Us Image',
  page3: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1571324062003-0f883291547a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODA1MzA3N3w&ixlib=rb-4.0.3&q=80&w=1080',
