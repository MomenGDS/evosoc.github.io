            ...
            {props.content1 ?? (
              <Fragment>
                <span className="testimonial17-text31 thq-body-small">
                  Working with the AI Automation agency has been a game-changer
                  for our business. The chatbot they developed for us has
                  significantly increased our lead generation and streamlined
                  ...
                  {props.review1 ?? (
                    <Fragment>
                      <span className="testimonial17-text29 thq-body-small">
                        ...
                        professional. They delivered exactly what we needed and
                  ...
                  {props.review2 ?? (
                    <Fragment>
                      <span className="testimonial17-text30 thq-body-small">
                        I am impressed with the level of automation and
                        integration provided by AI Automation agency. Our social
                        media pages have never looked better, thanks to their
                  ...
                  {props.review3 ?? (
                    <Fragment>
                      <span className="testimonial17-text32 thq-body-small">
                        AI Automation agency&apos;s chatbot for appointment
                        management has saved us valuable time and improved our
                        scheduling efficiency. I highly recommend their
                        services.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.review4 ?? (
                    <Fragment>
                      <span className="testimonial17-text25 thq-body-small">
                        The social media integration provided by AI Automation
                        agency has helped us reach a wider audience and engage
                        with our customers effectively. Their services have been
                        instrumental in our business growth.
                      </span>
                    </Fragment>
                  )}
                </span>
