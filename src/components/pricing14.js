        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text184 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
            ...
            <p>
              {props.content2 ?? (
                <Fragment>
                  <p className="pricing14-text160 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  <p>
                    {props.plan1 ?? (
                      <Fragment>
                        <p className="pricing14-text181 thq-body-large">
                          Starter Plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text191 thq-heading-3">
                          $99/month
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  <p>
                    {props.plan2 ?? (
                      <Fragment>
                        <p className="pricing14-text179 thq-body-large">
                          Professional Plan
                        </p>
                      </Fragment>
                    )}
                      ...
                      {props.plan2Feature4 ?? (
                        <Fragment>
                          <span className="pricing14-text195 thq-body-small">
                            Advanced Social Media Integration with Instagram,
                            Facebook, WhatsApp
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text207 thq-heading-3">
                          $399/month
                        </h3>
                      </Fragment>
                    )}
                      ...
                      {props.plan3Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text204 thq-body-small">
                            Customized Appointment Management Integration with
                            CRM Systems
                          </span>
                        </Fragment>
                      )}
                      ...
                      {props.plan3Feature4 ?? (
                        <Fragment>
                          <span className="pricing14-text167 thq-body-small">
                            + Advanced Social Media Integration with Instagram,
                            Facebook, WhatsApp, LinkedIn, Twitter, and more
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan3Feature5 ?? (
                        <Fragment>
                          <span className="pricing14-text180 thq-body-small">
                            + Full-Service Content Creation and Management for
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text178 thq-heading-3">
                          $199/month
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text201 thq-body-large">
                          $1999/year
                        </span>
                      </Fragment>
                    )}
                      ...
                      {props.plan1Feature11 ?? (
                        <Fragment>
                          <span className="pricing14-text199 thq-body-small">
                            Social Media Integration with Instagram, Facebook,
                            WhatsApp
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text165 thq-heading-3">
                          $299/month
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text175 thq-body-large">
                          $2999/year
                        </span>
                      </Fragment>
                    )}
                      ...
                      {props.plan2Feature11 ?? (
                        <Fragment>
                          <span className="pricing14-text182 thq-body-small">
                            Advanced Content Creation Services for Social Media
                            Pages
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing14-list-item26">
                    ...
                    <span>
                      {props.plan2Feature21 ?? (
                        <Fragment>
                          <span className="pricing14-text159 thq-body-small">
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  <span>
                    {props.plan31 ?? (
                      <Fragment>
                        <span className="pricing14-text196 thq-body-large">
                          Enterprise plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text197 thq-heading-3">
                          $499/month
                        </h3>
                      </Fragment>
                    )}
